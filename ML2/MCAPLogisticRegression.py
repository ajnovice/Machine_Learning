...
if __name__ == '__main__':
    ...
    def test():
        ...
        print(
            "Accuracy spam file:" + str((spam_right_prediction / (spam_right_prediction + spam_wrong_pediction)) * 100))
        print("Accuracy :" + str(((spam_right_prediction + ham_right_prediction) / (
                spam_right_prediction + spam_wrong_pediction + ham_right_prediction + ham_wrong_prediction)) * 100))
